...
    *top* ← *FirstOccurrence*(*symbol*) + *Count**symbol*(*top*, *LastColumn*)
    *bottom* ← *FirstOccurrence*(*symbol*) + *Count**symbol*(*bottom* + 1, *LastColumn*) − 1
